#!/usr/bin/env python3
"""导入 5/21 明细数据到 daily_flow_2026_may（增量）"""
import pandas as pd
import sqlite3
from datetime import datetime

DB_PATH = '/home/openclaw/.openclaw/workspace/business_flow.db'
EXCEL = '/home/openclaw/.openclaw/workspace/业务对账统计明细-20260522084638.xlsx'
...
if new_records:
    ...
    ''', new_records)
    conn.commit()
    print(f'✅ 成功插入 {cursor.rowcount:,} 条（executemany 返回）')
...
cursor.execute("""
    ...
    WHERE d IN ('2026-05-12','2026-05-20','2026-05-21')
    GROUP BY d
""")
