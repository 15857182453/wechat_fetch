#!/usr/bin/env python3
"""导入 5/26 明细数据到 daily_flow_2026_may（增量）"""
import pandas as pd
import sqlite3
from datetime import datetime

DB_PATH = '/home/openclaw/.openclaw/workspace/business_flow.db'
EXCEL = '/home/openclaw/.openclaw/workspace/业务对账统计明细-20260527083643.xlsx'
...
valid = df['业务完成时间'].notna()
print(f'📅 业务日期范围：{df.loc[valid, "业务完成时间"].min()} 到 {df.loc[valid, "业务完成时间"].max()}')
...
print(f'\n📊 daily_flow_2026_may 总计：{total:,} 条，¥{total_amount:,.2f}')
