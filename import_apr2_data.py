...
# 配置
EXCEL_FILE = '/mnt/c/Users/44238/Desktop/业务对账数据/4-2/业务对账统计明细-20260403085620.xlsx'
...
def clean_and_import_data():
    ...
    # 只保留4月2日的数据
    df = df[df['业务完成时间'].dt.date == pd.to_datetime('2026-04-02').date()]
    print(f"筛选后4月2日数据: {len(df)} 行")
