...
# -*- coding: utf-8 -*-
"""
导入 4 月 6 日业务对账明细数据到 SQLite 数据库
"""
...
# 配置
EXCEL_FILE = '/mnt/c/Users/44238/Desktop/业务对账数据/4-6/业务对账统计明细-20260407090816.xlsx'
...
def clean_and_import_data():
    ...
    for idx, row in df.iterrows():
        ...
        record = {
            ...
            'pay_status': str(row['收退标识'])[:10] if pd.notna(row['收退标识']) else None,
