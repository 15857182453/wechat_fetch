...
# 创建表
print("创建数据表 daily_flow_2026_jan_feb...")
cursor.execute('''
CREATE TABLE IF NOT EXISTS daily_flow_2026_jan_feb (
...
# 文件列表
files = [
    "/home/openclaw/.openclaw/workspace/2026年1月.xlsx",
    "/home/openclaw/.openclaw/workspace/2026年2月.xlsx"
]
...
for file_path in files:
    ...
    # 批量插入
    cursor.executemany('''
        INSERT INTO daily_flow_2026_jan_feb 
